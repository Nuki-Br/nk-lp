    ...
    <section className="w-full bg-nuki-cinza-claro">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-12 px-6 py-12 sm:px-8 sm:py-14 md:px-12 md:py-16 lg:flex-row lg:items-center lg:justify-between lg:gap-8 lg:px-16 lg:py-20 xl:pl-[108px] xl:pr-[99px] xl:py-[88px]">
        <div className="flex w-full flex-col items-start justify-center gap-6 lg:w-[416px] lg:shrink-0">
          <span className="rounded-full bg-nuki-verde-suave px-4 py-1.5 text-[12px] font-bold uppercase tracking-[0.6px] text-nuki-verde-02">
            Plataforma de personalização para incorporadoras
          </span>
          ...
          <p className="text-[16px] leading-7 tracking-[0.2px] text-nuki-cinza sm:text-[17px] md:text-[18px] lg:text-[19px] xl:text-[20px] xl:leading-9">
            A Nuki organiza a personalização de acabamentos de ponta a ponta — do
            memorial de custo à vistoria de entrega. Menos retrabalho entre as
            áreas, mais controle sobre a margem e uma experiência que o seu
            cliente sente.
          </p>
          <SolicitarDemoButton
