...
/**
 * Bloco visual imersivo compartilhado da hero: imagem do ambiente + quadrado
 * decorativo + menu lateral de ambientes + card de composição. Responsivo,
 * idêntico ao layout original da Hero.
 */
