  ...
  return (
    <section className="relative w-full overflow-hidden bg-nuki-preto h-auto">
      ...
      <img
        ...
        alt=""
        aria-hidden
        className="pointer-events-none absolute right-24 bottom-16 w-[140px] blur-[3px] max-lg:hidden"
      />

      <div className="relative mx-auto w-full max-w-[1440px] px-6 pt-16 pb-24 sm:px-8 sm:pt-20 sm:pb-28 md:px-12 md:pt-24 md:pb-32 lg:px-16 lg:pt-32 lg:pb-56 xl:px-27 xl:pt-40 xl:pb-64">
